...
export default StyleSheet.create({
    ...
    pls: {
        fontSize: wp(3), marginTop: hp(1), fontWeight: '100',
    },
    nameView: {
        marginTop: hp(2),
        height: hp(8),
    ...
    activeView: {
        marginHorizontal: wp(5), height: 1
    },
    flag: {
        height: hp(5), width: wp(6), marginLeft: wp(6)
    },
    phoneInput: {
        fontSize: wp(4), marginLeft: wp(0),
        height: hp(6), backgroundColor: global.Colors.white
    },
    bySign: {
        flexDirection: 'row',
        alignItems: 'center',
