...
export default StyleSheet.create({
    ...
    codeInput: {
        fontSize: wp(3.4),
        marginTop: hp(1), width: wp(29),
        borderBottomColor: global.Colors.gray, borderBottomWidth: 2, borderRadius: 1
    },
    cardHolderView: {
        marginTop: hp(2),
        marginHorizontal: wp(3)
    ...
    nameInput: {
        ...
        marginTop: hp(1),
        borderBottomColor: global.Colors.gray,
        borderBottomWidth: 2, borderRadius: 1
    },
    supported: {
        marginTop: hp(7),
        alignSelf: 'center', fontSize: wp(4),
