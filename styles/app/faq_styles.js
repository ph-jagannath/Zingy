...
export default StyleSheet.create({
    ...
    iconStyle: {
        height: hp(4), width: wp(5), marginRight: wp(3),
    },
    iconStyleFaq: {
        height: hp(3), width: wp(4), marginRight: wp(3),
    },
    ...
    shadowViewFaq: {
        ...
        elevation: 2,
        marginHorizontal: wp(4),
        borderBottomRightRadius: 15, backgroundColor: global.Colors.white,
    ...
    textTwo: {
        fontWeight: 'bold',
        fontSize: wp(3.5), width: wp(80), marginLeft: wp(5),
    ...
    notText: {
        alignSelf: 'center', fontSize: wp(2.5), color: global.Colors.white,
    },
})