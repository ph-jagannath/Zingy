...
export default class VerifyNumber extends Component {
  ...
  navigate = () => {
    if (this.state.navigation) this.props.navigation.navigate("WelcomeDacwash");
  };
  render() {
    return (
      <View style={styles.container}>
        ...
        <Header
          ...
          leftComponent={
            <TouchableOpacity
              onPress={() =>
                console.log("COnsole ", this.props.navigation.goBack())
              }
            >
              <Icon
                name="chevron-left"
        ...
        <ScrollView style={styles.container}>
          ...
          <View style={styles.verfyView}>
            <Text style={styles.verfyText}>{t("verifyNumber")}</Text>
            <View style={styles.pinView}>
              <Text style={styles.pintText}>{t("enterPin")}</Text>
              <Text style={styles.numbrText}>+3965656565</Text>
            </View>
          </View>
          <View style={styles.codeTopView}>
            ...
            <Text style={styles.otp}>{t("resendOtp")}</Text>
          </View>
