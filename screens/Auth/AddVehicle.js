        ...
        <ScrollView style={styles.containerMybooking}>
          <View style={styles.container2}>
            ...
            <View style={styles.TopViewAddVecle}>
              ...
              >
                <Text style={styles.category}>{t("addV_make")}</Text>
                {
                  <Image
                    source={make ? global.ASSETS.UP : global.ASSETS.DOWN}
            ...
            <View style={styles.TopViewAddVecle}>
              ...
              >
                <Text style={styles.category}>{t("addV_model")}</Text>
                {
                  <Image
                    source={model ? global.ASSETS.UP : global.ASSETS.DOWN}
                    style={styles.imgForword}
                  />
                }
              </TouchableOpacity>
            ...
            <View style={styles.TopViewAddVecle}>
              ...
              >
                <Text style={styles.category}>{t("addV_year")}</Text>
                {
                  <Image
                    source={year ? global.ASSETS.UP : global.ASSETS.DOWN}
                    style={styles.imgForword}
                  />
                }
              </TouchableOpacity>
            ...
            <View style={styles.TopViewAddVecle}>
              ...
              >
                <Text style={styles.categoryClr}>Color</Text>
                {
                  <Image
                    source={color ? global.ASSETS.UP : global.ASSETS.DOWN}
                    style={styles.imgForword}
                  />
                }
              </TouchableOpacity>
