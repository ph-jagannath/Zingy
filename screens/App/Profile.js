        ...
        return (
            <View style={styles.containerMybooking}>
                <View style={styles.statusView}>
                    <StatusBar
                        translucent backgroundColor={global.Colors.AppColor} barStyle="light-content" />
                </View>
                ...
                <ScrollView style={styles.containerMybooking}>
                    <View style={styles.horizonViewProfile}>
                        <View style={styles.HorizonRowViewProfile}>
                            <Image source={global.ASSETS.USER} style={styles.imgStyle} resizeMode={'center'} />
                    ...
                    <View style={styles.horizonViewProfile}>
                        <View style={styles.HorizonRowViewProfile}>
                            <Image source={global.ASSETS.EMAIL} style={styles.imgStyle} resizeMode={'center'} />
                            <View style={styles.profileRightView}>
                                <Text style={styles.nameText} >{t("signup_email")}</Text>
                                <Text style={styles.usrName}>
                                    nakulsharma0298@gmail.com
                             </Text>
                            </View>
                        </View>
                    </View>
                    <View style={styles.horizonViewProfile}>
                        <View style={styles.HorizonRowViewProfile}>
                            <Image source={global.ASSETS.MOBAIL} style={styles.MimgStyle} resizeMode={'cover'} />
                            <View style={styles.profileRightView}>
                    ...
                    <View style={styles.horizonViewProfile}>
                        <View style={styles.HorizonRowViewProfile}>
                            <Image source={global.ASSETS.LOCK} style={styles.imgStyle} resizeMode={'center'} />
                            <TouchableOpacity
                                onPress={() => this.props.navigation.navigate("ChangePassword")}
                                style={styles.profileRightView}>
                                <Text style={styles.nameText} >{t("profile_changePassword")}</Text>
                            </TouchableOpacity>
                        </View>
                    </View>
                </ScrollView>
