        ...
        return (
            <View>
                <TouchableOpacity
                    ...
                    style={[styles.touchAppClrView, { backgroundColor: index === 0 ? global.Colors.AppColor : global.Colors.white },]}>
                    <Text style={[styles.standrd, { color: index === 0 ? global.Colors.white : global.Colors.black, }]}>
                        {item.standard}
                    </Text>
                    <Text style={[styles.priceDacwash, { color: index === 0 ? global.Colors.white : global.Colors.black, }]}>
                        {item.price}
                    </Text>
                </TouchableOpacity>
            </View>
                ...
                <View style={styles.container}>
                    ...
                    <View style={styles.btmViewDacWashLocation}>
                        <View style={styles.apClrView}>
                            <Image source={global.ASSETS.CAR} resizeMode={'contain'} style={styles.imgCarDacWash} />
                            <Image source={global.ASSETS.CLEANING} resizeMode={'contain'} style={styles.imgCarDacWash} />
                            <Text style={styles.inOutText}>
                                {t("dacwash_insideOutSide")}
                          </Text>
                        </View>
                    </View>
