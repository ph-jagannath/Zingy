    ...
    return (
      <View style={styles.listContainerMyBook}>
        <View style={styles.ViewGreen}>
          ...
          <Text style={styles.standardPackage}>{item.standard}</Text>
        </View>
          ...
          <View style={styles.horzonView}>
            <View style={styles.itemes}>
              <Image
                ...
                style={styles.imgCar}
              />
              <Text style={styles.exteriorText}>{item.exterior}</Text>
            </View>
          </View>
          <View style={styles.horzonView}>
            <View style={styles.itemes}>
              ...
              />
              <Text style={styles.exteriorText}>{item.interior}</Text>
            </View>
          </View>
          ...
          <View style={styles.horzonView}>
            <View style={styles.itemes}>
              <Image
                ...
                style={styles.imgCar}
              />
              <Text style={styles.exteriorText}>{item.wash}</Text>
            </View>
          </View>
          <Text style={styles.expDate}>Expiry: {item.expiryDate}</Text>
        </View>
      </View>
    );
  };
