      ...
      <View style={styles.containerMybooking}>
        ...
        <ScrollView style={styles.containerMybooking}>
          ...
          <View style={styles.wahrView}>
            <Text style={styles.waherText}>{t("bookingD_Washertest")}</Text>
            <Text style={styles.number}>123456454</Text>
          </View>
          ...
          <View style={styles.starView}>
            <Stars
              ...
              starSize={50}
              fullStar={
                <Image source={global.ASSETS.STAR} style={styles.starStyle} />
              }
              emptyStar={
                <Image source={global.ASSETS.STAR} style={styles.emptyStar} />
              }
            />
          </View>
          ...
          <View style={styles.horizoView}>
            <View style={styles.spacBetView}>
              <View style={styles.leftViewBookingDetails}>
                ...
                <Text style={styles.paymText}>Card</Text>
              </View>
              <Text style={styles.EuroText}>€52.00</Text>
            </View>
            <View style={styles.spacBetView}>
              <View style={styles.leftViewBookingDetails}>
              ...
              >
                <Text
                  style={[
                    styles.mybook,
                    {
                      color: preTab ? "#C7c7c7" : "#fff",
                      textDecorationLine: preTab ? "underline" : "none",
                    },
                  ]}
                >
                  {t("bookingD_PreWash")}
              ...
              >
                <Text
                  style={[
                    styles.mybook,
                    {
                      color: preTab ? "#fff" : "#C7c7c7",
                      textDecorationLine: preTab ? "none" : "underline",
                    },
                  ]}
                >
