...
import { TextInput, ScrollView, Image, Text, StyleSheet, StatusBar, View, } from 'react-native';
        ...
        return (
            <View style={styles.container}>
                ...
                <Header containerStyle={styles.header} backgroundColor={global.Colors.AppColor}
                    leftComponent={
                        <TouchableOpacity style={styles.leftIcon} onPress={() => this.props.navigation.goBack()}>
                    ...
                    <View style={styles.thiredView}>
                        <View style={styles.expView}>
                            ...
                            <View style={styles.SimplerowView}>
                                <TextInput style={styles.mmInput}
                                    keyboardType="numeric"
                                    returnKeyType="next"
                                    maxLength={2}
                                    ...
                                    placeholderTextColor={global.Colors.gray}
                                />
                                <TextInput style={styles.yyInput}
                                    keyboardType="numeric"
                                    returnKeyType="next"
                                    maxLength={2}
