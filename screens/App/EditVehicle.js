...
import { ScrollView, Image, Text, StyleSheet, StatusBar, View, TextInput, KeyboardAvoidingView } from 'react-native';
                ...
                <Header containerStyle={styles.header} backgroundColor={global.Colors.AppColor}
                    leftComponent={
                        <TouchableOpacity onPress={() => this.props.navigation.goBack()}>
                            <Icon name="chevron-left" size={32} style={styles.leftIcon} color={global.Colors.white} />
                        </TouchableOpacity>
                    }
                    centerComponent={
                    ...
                    <KeyboardAvoidingView enabled style={styles.container3}>
                        ...
                        <View style={styles.borderViewEditV} >
                            <Text style={styles.codeText}>
                                {this.state.plateCode}
                            </Text>

                            <Image source={italy} style={styles.itlyEditV} resizeMode={'cover'} />
                        ...
                        <View style={styles.TopViewAddVecle}>
                            ...
                            <View style={styles.borderViewAddVehi}>
                                <TextInput style={styles.inputSearchV}
                                    // autoFocus={true}
