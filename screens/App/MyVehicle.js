                ...
                <View style={styles.rendTouch}>
                    ...
                    <View style={styles.delEdit}>
                        <TouchableOpacity onPress={() => navigate("EditVehicle")}>
                            <Icon name={"edit"} type={"mdiPencil"} size={20} color='#8E0404' />
                        </TouchableOpacity>
                        <TouchableOpacity>
                            <Image source={global.ASSETS.DELETE} resizeMode={'center'} style={styles.deleteIcon} />
                        </TouchableOpacity>
                        <TouchableOpacity style={styles.marRight}>
                            <Icon name="chevron-right" size={32} color='#6ABC45' style={styles.rightIcon} />
                        </TouchableOpacity>
