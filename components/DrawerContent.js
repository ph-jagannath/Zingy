      ...
      <View style={styles.container}>
        ...
        <ScrollView style={styles.container}>
          <View style={styles.TopViewDrawer}>
            ...
            <TouchableOpacity
              onPress={() => this.nextScreen("MyVehicle")}
              style={styles.contentTop}
            >
            ...
            <TouchableOpacity
              onPress={() => this.nextScreen("MyBookings")}
              style={styles.contentTop}
            >
            ...
            <TouchableOpacity
              onPress={() => this.nextScreen("Package")}
              style={styles.contentTop}
            >
            ...
            <TouchableOpacity
              onPress={() => this.nextScreen("Contact")}
              style={styles.contentTop}
            >
            ...
            <TouchableOpacity
              onPress={() => this.nextScreen("ChangeLanguage")}
              style={styles.contentTop}
            >
